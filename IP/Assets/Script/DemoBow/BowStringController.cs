...
{
    [SerializeField]
    private StringLogic bowStringRenderer;
    ...
    private void ResetBowString(SelectExitEventArgs arg0)
    {
        ...
        interactor = null;
        midPointGrabObject.localPosition = new Vector3(0,0, -0.1606f);
        midPointVisualObject.localPosition = new Vector3(0, 0, -0.1606f);
        bowStringRenderer.CreateLine(null);
    ...
    private void Update()
    {
        if (interactor != null)
        {
            ...
            bowStringRenderer.CreateLine(midPointVisualObject.position);
        }
    }
